    ...
    <>
      <div className="container">
        ...
        <p className="textaoTrocado">
          ...
          compromisso inabalável em melhorar a qualidade de vida das pessoas,
          nossa jornada é impulsionada pela inovação, sustentabilidade e o
          desejo sincero de criar um mundo onde todos possam respirar com
          facilidade.
        </p>
        ...
        <p className="textaoTrocado">
          ...
          apenas em nossas vidas, mas em todo o planeta.
        </p>
        ...
        <p className="textaoTrocado">
          ...
          algas para purificar o ar que você respira. As algas absorvem CO2 e
          liberam oxigênio, tornando o ambiente mais fresco e saudável. O
          AquaTank é uma maneira eficaz e natural de melhorar a qualidade do ar
        ...
        <p className="textaoTrocado">
          ...
          fresco para viver, trabalhar e prosperar.
        </p>

        <h1>Por Que Escolher a SoftForge?</h1>
        <ol>
          <li>
            Compromisso Inabalável: Somos apaixonados e dedicados à qualidade do
            ar, comprometidos com nossa missão.
          </li>
          <li>
            Inovação Sustentável: O AquaTank reflete nosso compromisso com
            soluções ecologicamente conscientes e a promoção da
            sustentabilidade.
          </li>
          <li>
            Qualidade Intransigente: Cada AquaTank é criado com precisão e
            qualidade excepcionais, atendendo aos mais altos padrões.
          </li>
          <li>
            Foco no Cliente: Valorizamos nossos clientes e parceiros, buscando
            ouvir, aprender e crescer juntos.
          </li>
        </ol>
        ...
        <p className="textaoTrocado">
          ...
          direção a um ar mais puro e uma vida melhor.
        </p>
