        ...
        <>
            <div className='container'>
                <h1>Sobre Nós</h1>
                    ...
                    <p className='Vagabundo'>Na SoftForge, acreditamos que o futuro é agora. Nosso compromisso com a melhoria da qualidade do ar é sério, visando moldar um amanhã mais saudável e vibrante. Junte-se a nós nessa emocionante jornada em direção a um ar mais puro e uma vida melhor.</p>
